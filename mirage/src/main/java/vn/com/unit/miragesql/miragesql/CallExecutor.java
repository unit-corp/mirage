...
import vn.com.unit.miragesql.miragesql.annotation.InOut;
import vn.com.unit.miragesql.miragesql.annotation.Out;
...
import vn.com.unit.miragesql.miragesql.util.ModifierUtil;
import vn.com.unit.miragesql.miragesql.util.ReflectionUtil;
...
//	}
    ...
    protected List<ParamDesc> createParamDesc(final Class<?> clazz) {
        ...
        for (int i = 0; i < beanDesc.getPropertyDescSize(); ++i) {
            ...
            if (pd.getAnnotation(vn.com.unit.miragesql.miragesql.annotation.ResultSet.class) != null) {
